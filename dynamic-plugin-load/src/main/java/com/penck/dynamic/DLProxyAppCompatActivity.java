...
import com.penck.dynamic.internal.DLPluginPackage;
...
public class DLProxyAppCompatActivity extends AppCompatActivity implements DLPlugin {

    /**
     * 代理AppCompatActivity，可以当作Context来使用，会根据需要来决定是否指向this
     */
