...
import com.penck.dynamic.DLBasePluginFragmentActivity;
import com.penck.dynamic.DLBasePluginService;
import com.penck.dynamic.DLProxyActivity;
import com.penck.dynamic.DLProxyAppCompatActivity;
import com.penck.dynamic.DLProxyFragmentActivity;
import com.penck.dynamic.DLProxyService;
import com.penck.dynamic.utils.DLConstants;
import com.penck.dynamic.utils.SoLibManager;
...
public class DLPluginManager {
    ...
    private Class<? extends Activity> getProxyActivityClass(Class<?> clazz) {
        ...
        if (DLBasePluginActivity.class.isAssignableFrom(clazz)) {
            ...
            activityClass = DLProxyAppCompatActivity.class;//新添加的
        }
    ...
    private void performStartActivityForResult(Context context, DLIntent dlIntent, int requestCode) {
        Log.i("plugin", "launch " + dlIntent.getPluginClass());
